...
class ParentInfoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'mother_name': forms.TextInput(attrs={'class': 'form-control form-control-neural', 'placeholder': 'Enter mother\'s name'}),
            'father_occupation': forms.TextInput(attrs={'class': 'form-control form-control-neural', 'placeholder': 'Enter father\'s occupation'}),
            'mother_occupation': forms.TextInput(attrs={'class': 'form-control form-control-neural', 'placeholder': 'Enter mother\'s occupation'}),
            ...
            'alternate_mobile': forms.TextInput(attrs={'class': 'form-control form-control-neural', 'placeholder': 'Enter alternate mobile number'}),
        }
...
class FeeDetailsForm(forms.ModelForm):
    ...
    def clean_fees_remaining(self):
        ...
        if fees_remaining and fees_remaining < 0:
            raise forms.ValidationError('Remaining fees cannot be negative')
        
        if total_fees and fees_remaining and fees_remaining > total_fees:
