...
urlpatterns = [
    ...
    # Message Analytics
    path('message-analytics/', views.message_analytics_dashboard, name='message_analytics_dashboard'),
    path('api/update-message-status/', views.update_message_status, name='update_message_status'),
    path('api/export-analytics-data/', views.export_analytics_data, name='export_analytics_data'),
]