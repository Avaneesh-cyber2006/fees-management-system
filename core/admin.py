...
class StudentAdmin(admin.ModelAdmin):
    ...
    def get_course(self, obj):
        ...
        except (AcademicInfo.DoesNotExist, AttributeError):
            return 'N/A'
    ...
    def get_fees_status(self, obj):
        try:
            if obj.feedetails.fees_remaining > 0:
                ...
                return 'Paid'
        except (FeeDetails.DoesNotExist, AttributeError):
            return 'N/A'
...
class ParentInfoAdmin(admin.ModelAdmin):
    list_display = ['registration_no', 'father_name', 'father_occupation', 'father_mobile', 'mother_mobile']
    search_fields = ['father_name', 'father_mobile', 'mother_mobile', 'registration_no__first_name', 'registration_no__last_name']
